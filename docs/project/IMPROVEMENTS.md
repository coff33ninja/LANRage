...
**File**: `core/gameplay/server_browser.py`
...
**File**: `core/control_plane/control.py`
...
**File**: `core/gameplay/games.py`, `core/networking/network.py`
...
**Improvements**:
- [x] Detect NAT type on startup (already in `core/networking/nat.py`)
...
**File**: `core/integrations/discord_integration.py`
...
**File**: `core/gameplay/broadcast.py`
...
**Improvements**:
- [ ] Hook into game detection (`core/gameplay/games.py`)
...
**File**: `core/control_plane/party.py`, `core/networking/network.py`
...
**File**: `core/control_plane/party.py`
